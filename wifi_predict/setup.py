...
setup(
    ...
    data_files=[
        ...
        # Optional: static fingerprint data (for prebuilt DBs)
        (os.path.join('share', package_name, 'runtime_1D_fingerprint_data'), glob(os.path.join('runtime_1D_fingerprint_data', '*.*'))),
    ],
